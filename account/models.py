...
class EmailAddress(models.Model):
    ...
    def __init__(self, *args, **kwargs):
        self.email_confirmation_model = get_model(*settings.ACCOUNT_EMAIL_CONFIRMATION_MODEL.split('.'))
    ...
    def send_confirmation(self):
        confirmation = self.email_confirmation_model.create(self)
        confirmation.send()
        return confirmation
